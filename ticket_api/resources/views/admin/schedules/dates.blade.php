...
<div class="bg-white shadow rounded-lg p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <div>
            <a href="{{ route('admin.schedules.show', $schedule) }}" class="bg-gray-500 hover:bg-gray-600 text-white py-2 px-4 rounded mr-2">
                <i class="fas fa-arrow-left mr-2"></i> Kembali
            </a>
            <button id="addDateBtn" class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p class="font-medium">
                        ...
                        @else
                            <span class="px-2 py-1 rounded-full text-xs bg-red-100 text-red-800">Tidak Aktif</span>
                        @endif
                    </p>
                </div>
            </div>
    ...
    <div class="mb-6 flex flex-col md:flex-row md:items-center gap-4">
        <div>
            ...
            <select id="month" name="month" class="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
        ...
        <div>
            ...
            <select id="year" name="year" class="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
        ...
        <table class="min-w-full bg-white">
            <thead>
                <tr>
                    ...
                    <th class="py-3 px-4 border-b border-gray-200 text-left text-sm font-semibold text-gray-700">Tanggal</th>
                    ...
                    <th class="py-3 px-4 border-b border-gray-200 text-left text-sm font-semibold text-gray-700">Kendaraan</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="py-3 px-4 border-b border-gray-200 text-sm">{{ \Carbon\Carbon::parse($date->date)->format('d/m/Y') }}</td>
                    <td class="py-3 px-4 border-b border-gray-200 text-sm">{{ \Carbon\Carbon::parse($date->date)->translatedFormat('l') }}</td>
                    ...
                    <td class="py-3 px-4 border-b border-gray-200 text-sm">
                        @if(is_object($schedule->ferry))
                            M: {{ $date->motorcycle_count ?? 0 }} / {{ $schedule->ferry->capacity_vehicle_motorcycle }}<br>
                    ...
                    <td class="py-3 px-4 border-b border-gray-200 text-sm">
                        @if($date->status == 'AVAILABLE')
                            <span class="px-2 py-1 rounded-full text-xs bg-green-100 text-green-800">Tersedia</span>
                        @else
                            <span class="px-2 py-1 rounded-full text-xs bg-red-100 text-red-800">Tidak Tersedia</span>
                        @endif
                    </td>
                    <td class="py-3 px-4 border-b border-gray-200 text-sm">
                        <button class="edit-date-btn text-yellow-500 hover:text-yellow-700 mr-2" data-id="{{ $date->id }}" data-date="{{ $date->date }}" data-status="{{ $date->status }}">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="delete-date-btn text-red-500 hover:text-red-700" data-id="{{ $date->id }}" data-date="{{ \Carbon\Carbon::parse($date->date)->format('d/m/Y') }}">
                ...
                @empty
                <tr>
                    <td colspan="7" class="py-3 px-4 border-b border-gray-200 text-sm text-center">Tidak ada tanggal terjadwal</td>
                </tr>
                @endforelse
            </tbody>
        </table>
...
<!-- Add Date Modal -->
<div id="addDateModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center">
    <div class="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <form id="addDateForm" action="{{ route('admin.schedules.dates.store', $schedule) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select id="date_type" name="date_type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
            ...
            <div id="singleDateFields">
                <div class="mb-4">
                    ...
                    <input type="date" id="single_date" name="single_date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
            ...
            <div id="rangeDateFields" class="hidden">
                <div class="mb-4">
                    ...
                    <input type="date" id="start_date" name="start_date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="mb-4">
                    <label for="end_date" class="block text-sm font-medium text-gray-700 mb-2">Tanggal Akhir</label>
                    <input type="date" id="end_date" name="end_date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
            ...
            <div id="daysFields" class="hidden">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" id="days_start_date" name="days_start_date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="mb-4">
                    <label for="days_end_date" class="block text-sm font-medium text-gray-700 mb-2">Tanggal Akhir</label>
                    <input type="date" id="days_end_date" name="days_end_date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
            ...
            <div class="flex justify-end mt-6">
                <button type="button" id="cancelAddBtn" class="bg-gray-500 hover:bg-gray-600 text-white py-2 px-4 rounded mr-2">
                    Batal
                </button>
    ...
    <div class="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <form id="editDateForm" action="#" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="date" id="edit_date" name="date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
            </div>

            <div class="mb-4">
                <label for="edit_status" class="block text-sm font-medium text-gray-700 mb-2">Status</label>
                <select id="edit_status" name="status" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    <option value="AVAILABLE">Tersedia</option>
                    <option value="UNAVAILABLE">Tidak Tersedia</option>
                </select>
            </div>
            ...
            <div class="flex justify-end mt-6">
                <button type="button" id="cancelEditBtn" class="bg-gray-500 hover:bg-gray-600 text-white py-2 px-4 rounded mr-2">
                    Batal
                </button>
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded">
                    Simpan Perubahan
...
<div id="deleteDateModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center">
    <div class="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <form id="deleteDateForm" action="#" method="POST">
            ...
            @method('DELETE')
            <div class="flex justify-end mt-6">
                <button type="button" id="cancelDeleteBtn" class="bg-gray-500 hover:bg-gray-600 text-white py-2 px-4 rounded mr-2">
                    Batal
                </button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                deleteConfirmText.textContent = `Apakah Anda yakin ingin menghapus jadwal untuk tanggal ${dateText}?`;
