...
@section('content')
    <div class="bg-white shadow-md rounded-xl overflow-hidden">
        <!-- Header -->
        <div class="p-6 bg-gradient-to-r from-indigo-50 via-indigo-100 to-purple-50 border-b relative">
            <div class="absolute right-0 bottom-0 opacity-30 pointer-events-none">
                <svg width="150" height="150" viewBox="0 0 150 150" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        transform="translate(75 75)" fill="#6366F1" />
                </svg>
            </div>
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 relative z-10">
                ...
                <a href="{{ route('admin.schedules.create') }}"
                    class="bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-lg transition shadow-md hover:shadow flex items-center">
