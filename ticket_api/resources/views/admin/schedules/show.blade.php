...
<div class="bg-white shadow rounded-lg p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <div>
            <a href="{{ route('admin.schedules.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white py-2 px-4 rounded mr-2">
                <i class="fas fa-arrow-left mr-2"></i> Kembali
            </a>
            <a href="{{ route('admin.schedules.edit', $schedule) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-4 rounded mr-2">
                <i class="fas fa-edit mr-2"></i> Edit
            </a>
            <a href="{{ route('admin.schedules.dates', $schedule) }}" class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded">
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="5" class="py-3 px-4 border-b border-gray-200 text-sm text-center">Tidak ada tanggal terjadwal</td>
                </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="py-3 px-4 border-b border-gray-200 text-sm font-medium">{{ $booking->booking_code }}</td>
                        <td class="py-3 px-4 border-b border-gray-200 text-sm">{{ \Carbon\Carbon::parse($booking->travel_date)->format('d/m/Y') }}</td>
                        ...
                        <td class="py-3 px-4 border-b border-gray-200 text-sm">
                            @if($booking->status == 'CONFIRMED')
                                <span class="px-2 py-1 rounded-full text-xs bg-green-100 text-green-800">Terkonfirmasi</span>
                        ...
                        <td class="py-3 px-4 border-b border-gray-200 text-sm">
                            <a href="{{ route('admin.bookings.show', $booking) }}" class="text-blue-500 hover:text-blue-700">
