                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select id="route_id" name="route_id" required
                                    class="pl-10 bg-white border @error('route_id') border-red-300 @else border-gray-300 @enderror text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
