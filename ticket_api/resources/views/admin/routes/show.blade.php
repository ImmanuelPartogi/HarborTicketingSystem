...
@section('content')
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="flex flex-col md:flex-row gap-6 mb-6">
                ...
                <div class="flex-1">
                    <h2 class="text-xl font-bold mb-2 text-gray-800">{{ $route->origin }} - {{ $route->destination }}</h2>
    ...
    <div id="rescheduleModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden modal-container">
        <div class="flex items-center justify-center h-full w-full p-4">
            <div class="bg-white rounded-lg p-6 w-full max-w-lg relative shadow-xl modal-content">
                <div class="flex justify-between items-center mb-4 border-b pb-3">
                    <h3 class="text-lg font-semibold text-gray-800 flex items-center">
                        <i class="fas fa-calendar-alt text-blue-500 mr-2"></i> Reschedule Jadwal
                    </h3>
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Reschedule type radio buttons functionality
            ...
            [rescheduleAllRadio, rescheduleSelectedRadio].forEach(radio => {
                radio.addEventListener('change', function() {
                    if (rescheduleSelectedRadio.checked) {
                        affectedDatesContainer.classList.remove('hidden');
                    } else {
                        affectedDatesContainer.classList.add('hidden');
                    }
                });
            });
        });
