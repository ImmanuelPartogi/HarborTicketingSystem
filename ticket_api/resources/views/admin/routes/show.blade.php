            ...
            <div class="mb-6 {{ $route->status == 'WEATHER_ISSUE' ? 'bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700' : 'bg-red-100 border-l-4 border-red-500 text-red-700' }} p-4 rounded-r"
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-sm mt-1">
                            @if ($route->status == 'WEATHER_ISSUE')
                                Semua jadwal pada rute ini telah ditandai sebagai tertunda dan dapat di-reschedule.
                            @else
                                Semua jadwal pada rute ini telah ditandai sebagai dibatalkan.
                            @endif
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <div class="flex items-center">
                        ...
                        <label for="apply_to_schedules" class="text-sm text-gray-700">
                            Terapkan perubahan status ke semua jadwal yang menggunakan rute ini
                        </label>
                    </div>
                    <p class="text-xs text-gray-600 mt-1">
                        Jika dicentang, semua jadwal yang menggunakan rute ini akan diperbarui statusnya sesuai:
                            ...
                            <tr>
                                ...
                                <td class="py-3 px-4 border-b border-gray-200 text-sm">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        @if ($schedule->status == 'DELAYED' && $route->status == 'WEATHER_ISSUE')
                                            <button type="button"
                ...
                <form id="rescheduleForm" action="#" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label for="reschedule_date" class="block text-sm font-medium text-gray-700 mb-2">Tanggal
                            Baru</label>
                        <input type="date" id="reschedule_date" name="date"
                    ...
                    <div>
                        ...
                        <input type="time" id="reschedule_time" name="time"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    </div>
