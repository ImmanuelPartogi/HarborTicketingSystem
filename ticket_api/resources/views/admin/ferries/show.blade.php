            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="{{ route('admin.ferries.edit', $ferry->id) }}"
                        class="action-button bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-4 rounded-lg transition duration-300 flex items-center shadow-md">
                        <i class="fas fa-edit mr-2"></i> Edit
                    </a>
                    <a href="{{ route('admin.ferries.index') }}"
                        class="action-button bg-white text-blue-700 hover:bg-blue-50 py-2 px-4 rounded-lg transition duration-300 flex items-center shadow-md">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="col-span-1">
                    <div
                        class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl overflow-hidden shadow-sm p-5 border border-blue-100">
                        <div class="flex justify-center mb-6">
                            ...
                            @else
                                <div
                                    class="ferry-image bg-blue-100 w-full h-56 rounded-lg flex items-center justify-center shadow-md">
                        ...
                        <div class="flex justify-center mb-4">
                            @if ($ferry->status == 'ACTIVE')
                                <span
                                    class="px-4 py-1 rounded-full text-sm font-semibold bg-green-100 text-green-800 flex items-center">
                                    <i class="fas fa-check-circle mr-2"></i> Aktif
                                </span>
                            @elseif($ferry->status == 'MAINTENANCE')
                                <span
                                    class="px-4 py-1 rounded-full text-sm font-semibold bg-yellow-100 text-yellow-800 flex items-center">
                                    <i class="fas fa-tools mr-2"></i> Pemeliharaan
                                </span>
                            @else
                                <span
                                    class="px-4 py-1 rounded-full text-sm font-semibold bg-red-100 text-red-800 flex items-center">
                    ...
                    <div class="capacity-card mb-6 overflow-hidden">
                        ...
                        <div class="p-5 capacity-section">
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                                <div
                                    class="stat-card flex items-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xl font-bold text-gray-800">
                                            {{ number_format($ferry->capacity_passenger) }}</p>
                                        <p class="text-xs text-gray-500">orang</p>
                                    </div>
                                </div>

                                <div
                                    class="stat-card flex items-center p-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xl font-bold text-gray-800">
                                            {{ number_format($ferry->capacity_vehicle_motorcycle) }}</p>
                                        <p class="text-xs text-gray-500">unit</p>
                                    </div>
                                </div>

                                <div
                                    class="stat-card flex items-center p-4 bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg border border-indigo-200">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xl font-bold text-gray-800">
                                            {{ number_format($ferry->capacity_vehicle_car) }}</p>
                                        <p class="text-xs text-gray-500">unit</p>
                                    </div>
                                </div>

                                <div
                                    class="stat-card flex items-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xl font-bold text-gray-800">
                                            {{ number_format($ferry->capacity_vehicle_bus) }}</p>
                                        <p class="text-xs text-gray-500">unit</p>
                                    </div>
                                </div>

                                <div
                                    class="stat-card flex items-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xl font-bold text-gray-800">
                                            {{ number_format($ferry->capacity_vehicle_truck) }}</p>
                                        <p class="text-xs text-gray-500">unit</p>
                                    </div>
                                </div>

                                <div
                                    class="stat-card flex items-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200 sm:col-span-2 md:col-span-3">
                                    <div class="w-full">
                                        ...
                                        <div class="h-4 w-full bg-gray-200 rounded-full overflow-hidden">
                                            @php
                                                $totalVehicles =
                                                    $ferry->capacity_vehicle_motorcycle +
                                                    $ferry->capacity_vehicle_car +
                                                    $ferry->capacity_vehicle_bus +
                                                    $ferry->capacity_vehicle_truck;
                                                $motorcyclePercent =
                                                    $totalVehicles > 0
                                                        ? ($ferry->capacity_vehicle_motorcycle / $totalVehicles) * 100
                                                        : 0;
                                                $carPercent =
                                                    $totalVehicles > 0
                                                        ? ($ferry->capacity_vehicle_car / $totalVehicles) * 100
                                                        : 0;
                                                $busPercent =
                                                    $totalVehicles > 0
                                                        ? ($ferry->capacity_vehicle_bus / $totalVehicles) * 100
                                                        : 0;
                                                $truckPercent =
                                                    $totalVehicles > 0
                                                        ? ($ferry->capacity_vehicle_truck / $totalVehicles) * 100
                                                        : 0;
                                            @endphp
                                            <div class="h-full bg-gray-600 float-left"
                                                style="width: {{ $motorcyclePercent }}%"></div>
                                            <div class="h-full bg-indigo-500 float-left"
                                                style="width: {{ $carPercent }}%"></div>
                                            <div class="h-full bg-green-500 float-left"
                                                style="width: {{ $busPercent }}%"></div>
                                            <div class="h-full bg-orange-500 float-left"
                                                style="width: {{ $truckPercent }}%"></div>
                                        </div>
                        ...
                        <div class="p-4">
                            <div class="overflow-x-auto">
                                ...
                                <div class="hidden sm:block">
                                    <table class="min-w-full bg-white border-collapse">
                                        <thead>
                                            <tr class="bg-gray-50">
                                                <th
                                                    class="py-3 px-4 border-b border-gray-200 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                                                    Rute</th>
                                                <th
                                                    class="py-3 px-4 border-b border-gray-200 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                                                    Hari</th>
                                                ...
                                                <tr class="schedule-row">
                                                    ...
                                                    <td class="py-3 px-4 border-b border-gray-200 text-sm">
                                                        @if ($schedule->status == 'ACTIVE')
                                                            <span
                                                                class="px-2 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-800 flex items-center w-fit">
                                                                <i class="fas fa-check-circle mr-1"></i> Aktif
                                                            </span>
                                                        @else
                                                            <span
                                                                class="px-2 py-1 rounded-full text-xs font-semibold bg-red-100 text-red-800 flex items-center w-fit">
                                                ...
                                                <tr>
                                                    <td colspan="5"
                                                        ...
                                                        <div class="flex flex-col items-center">
                                                            <i
                                                                class="fas fa-calendar-times text-gray-300 text-3xl mb-2"></i>
                                                            <p>Tidak ada jadwal keberangkatan</p>
                                                            <a href="{{ route('admin.schedules.create') }}"
                                                                class="mt-3 px-3 py-1 bg-blue-600 text-white rounded-lg text-sm inline-flex items-center">
                                ...
                                <div class="sm:hidden space-y-4">
                                    @forelse($ferry->schedules as $schedule)
                                        <div
                                            class="mobile-schedule bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
