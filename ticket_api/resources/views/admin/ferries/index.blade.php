            ...
            <table class="min-w-full bg-white">
                <thead>
                    <tr>
                        ...
                        <th class="py-3 px-4 border-b border-gray-200 text-left text-sm font-semibold text-gray-700">Nama
                            Kapal</th>
                ...
                <tbody>
                            ...
                            <td class="py-3 px-4 border-b border-gray-200 text-sm">
                                ...
                                <form action="{{ route('admin.ferries.destroy', $ferry->id) }}" method="POST"
                                    ...
                                    <button type="submit" class="text-red-500 hover:text-red-700"
                                        onclick="return confirm('Apakah Anda yakin ingin menghapus kapal ini?')">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="py-3 px-4 border-b border-gray-200 text-sm text-center">Tidak ada data
                                kapal</td>
                        </tr>
                    @endforelse
                </tbody>
