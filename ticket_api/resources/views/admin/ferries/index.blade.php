...
<div class="bg-white shadow-lg rounded-lg overflow-hidden table-shadow">
    ...
    <div class="page-header p-6 text-white">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <a href="{{ route('admin.ferries.create') }}" class="bg-white text-blue-600 hover:bg-blue-50 py-2 px-4 rounded-lg transition shadow-sm hover:shadow flex items-center">
    ...
    <div class="px-6 pb-4">
        <form method="GET" action="{{ route('admin.ferries.index') }}" class="filter-section p-5 rounded-lg border border-gray-200 shadow-sm">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-end gap-2">
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg transition flex items-center shadow-sm hover:shadow">
                        <i class="fas fa-search mr-2"></i> Cari
                    </button>
                    @if($search || $status)
                        <a href="{{ route('admin.ferries.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white py-2 px-4 rounded-lg transition flex items-center shadow-sm hover:shadow">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                                ...
                                <div class="flex items-center">
                                    @if($ferry->image)
                                        <div class="ferry-avatar flex-shrink-0 h-10 w-10 mr-3">
                                            <img class="h-10 w-10 rounded-full object-cover shadow-sm border border-gray-200" src="{{ asset('storage/' . $ferry->image) }}" alt="{{ $ferry->name }}">
                                        </div>
                                    @else
                                        <div class="ferry-avatar flex-shrink-0 h-10 w-10 mr-3 bg-blue-100 rounded-full flex items-center justify-center border border-blue-200">
                            ...
                            <td class="py-4 px-4 whitespace-nowrap">
                                @if ($ferry->status == 'ACTIVE')
                                    <span class="animated-badge active px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                        ...
                        <tr>
                            <td colspan="6" class="py-8 px-4 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <a href="{{ route('admin.ferries.create') }}" class="mt-4 bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg transition flex items-center shadow-sm hover:shadow">
                                        <i class="fas fa-plus mr-2"></i> Tambah Kapal Baru
                                    </a>
                                </div>
                            </td>
                        ...
                        <div class="flex items-center flex-1">
                            @if($ferry->image)
                                <div class="ferry-avatar flex-shrink-0 h-12 w-12 mr-3">
                                    <img class="h-12 w-12 rounded-full object-cover shadow-sm border border-gray-200" src="{{ asset('storage/' . $ferry->image) }}" alt="{{ $ferry->name }}">
                                </div>
                            @else
                                <div class="ferry-avatar flex-shrink-0 h-12 w-12 mr-3 bg-blue-100 rounded-full flex items-center justify-center border border-blue-200">
                        ...
                        <div class="grid grid-cols-2 gap-3 mb-4">
                            <div class="card-entry flex items-center py-2">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm font-medium">{{ number_format($ferry->capacity_passenger) }}</div>
                                </div>
                            </div>
                            <div class="card-entry flex items-center py-2">
                                <i class="fas fa-motorcycle text-gray-400 mr-2 w-5"></i>
                                <div>
                                    ...
                                    <div class="text-sm font-medium">{{ number_format($ferry->capacity_vehicle_motorcycle) }}</div>
                                </div>
                            </div>
                            <div class="card-entry flex items-center py-2">
                                <i class="fas fa-car text-gray-400 mr-2 w-5"></i>
                                <div>
                                    ...
                                    <div class="text-sm font-medium">{{ number_format($ferry->capacity_vehicle_car) }}</div>
                                </div>
                            </div>
                            <div class="card-entry flex items-center py-2">
                                <i class="fas fa-bus text-gray-400 mr-2 w-5"></i>
                                <div>
                                    ...
                                    <div class="text-sm font-medium">{{ number_format($ferry->capacity_vehicle_bus) }}</div>
                                </div>
                            </div>
                        </div>
            ...
            @empty
                <div class="bg-white rounded-lg border border-gray-200 py-8 px-4 text-center text-gray-500 shadow-sm">
                    <div class="flex flex-col items-center">
                        ...
                        <a href="{{ route('admin.ferries.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg transition flex items-center shadow-sm hover:shadow">
                            <i class="fas fa-plus mr-2"></i> Tambah Kapal Baru
                        </a>
                    </div>
                </div>
