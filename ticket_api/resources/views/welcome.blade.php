...
<body class="antialiased bg-gray-50">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    <div class="flex-shrink-0 flex items-center">
                        <img class="h-8 sm:h-10 w-auto" src="{{ asset('images/logo.png') }}" alt="Ferry Ticket Logo">
                        <span class="ml-2 text-lg sm:text-xl font-bold text-primary-600 truncate">FerryTicket</span>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="mt-2 sm:mt-4 text-base sm:text-lg text-gray-600">
                    {{ $settings['routes_subtitle'] ?? 'Jelajahi semua rute feri kami yang menghubungkan pulau-pulau' }}</p>
            </div>
    ...
    <section id="contact" class="bg-gray-900 text-white pt-16 sm:pt-20 pb-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div
                class="border-t border-gray-800 mt-10 sm:mt-16 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="bg-white rounded-xl p-5 sm:p-8 max-w-md w-full mx-4 relative overflow-hidden modal-fade-in">
            ...
            <div class="relative z-10">
                ...
                <div class="text-center mb-3 relative">
                    ...
                    <p class="text-gray-600 mb-1 text-sm sm:text-base">Rasakan pengalaman pemesanan feri yang lancar</p>
                ...
                <div class="mb-6 mt-3">
                    ...
                    <div id="app-features-content" class="block">
                        <div class="flex flex-col items-center">
                            ...
                            <h4 class="text-base sm:text-lg font-semibold text-gray-800 mb-2">Pemesanan yang Cepat & Mudah</h4>
                    ...
                    <div id="download-content" class="hidden">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-xs sm:text-sm text-gray-500 mb-4">Gunakan kamera ponsel Anda untuk memindai kode QR ini
                            </p>
